...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Pro-Tech Shine | Home Page</title>


        <!-- Favicon -->
        <link href="img\download (1).jpg" rel="icon">
...
<?php include_once('includes/header.php');?>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="about-content">
                            <p>
                            Car detailing services are much more precise and labor-intensive than getting a car wash. A car wash is normally an automated system that a car passes through to clean the exterior. 
                            </p>
                            <ul>
        ...
        <!-- Facts Start -->
        <div class="facts" data-parallax="scroll" data-image-src="img\car3.jpg">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>Rs.</span><strong>999</strong>
                            </div>
                    ...
                    <div class="col-md-4">
                        <div class="price-item featured-item">
                            <div class="price-header">
                                ...
                                <h2><span>Rs.</span><strong>2999</strong>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
                    ...
                    <div class="col-md-4">
                        <div class="price-item">
                            <div class="price-header">
                                ...
                                <h2><span>Rs</span><strong>4999</strong>
                            </div>
                            <div class="price-body">
                                <ul>
                                    <li><i class="far fa-check-circle"></i>Seats Washing</li>
...
<form method="post">   
  <p>
            <select name="packagetype" required class="form-control">
                ...
                <option value="1">BASIC CLEANING (999)</option>
                 <option value="2">PREMIUM CLEANING (2999)</option>
                  <option value="3 ">COMPLEX CLEANING(4999)</option>
              </select>
